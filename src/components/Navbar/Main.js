...
const Navbar = () => {
    ...
    const activeMenu = () => {
        ...
        } else if (path === "/onlinebooking" || path === "/pricing" || path === "/contact" || path === "/faqs" || path === "/gallery" || path === "/help" || path === "/error") {
            setmenu({ pages: true })
    ...
    return (
        <>
                        ...
                        <div className="topbar__inner">
                            <ul className="list-unstyled topbar__infos">
                                <li className="topbar__infos-item">
                                    <Link to="#" className="topbar__infos-link"><i className="far fa-clock"></i> Monday to Saturday 9:00 to
                                        6:00</Link>
                                </li>
                                <li className="topbar__infos-item">
                                    <Link to="tel:92-666-888-0000" className="topbar__infos-link" ><i className="fa fa-phone-alt"></i> 92 666
                                        888 000</Link>
                                </li>
                            </ul>
                    ...
                    <div className="container">
                        <div className="main-menu__inner">
                            <div className="main-menu__logo">
                                <Link to="/">
                                    <img src="assets/images/logo-light.png" width="137" alt="Crsine - Car services react template" />
                                </Link>
                            </div>
            ...
            <div className={`mini-cart ${cart ? "expanded" : ""}`}>
                <div className="mini-cart__overlay mini-cart__toggler" onClick={() => setcart(false)}></div>
                <div className="mini-cart__content">
                    <div className="mini-cart__top">
                        <h3 className="mini-cart__title">Shopping Cart</h3>
                        <span className="mini-cart__close mini-cart__toggler"><i className="organik-icon-close"></i></span>
                    </div>
                    ...
                    <div className="mini-cart__item">
                        ...
                        <div className="mini-cart__item-content">
                            <div className="mini-cart__item-top">
                                <h3><Link to="/shopdetails">Oil Filters </Link></h3>
                                <p>$9.99</p>
                            </div>
                            <div className="quantity-box">
                                <button type="button" className="sub">-</button>
                    ...
                    <Link to="#" className="thm-btn mini-cart__checkout">Proceed To Checkout <i className="far fa-arrow-alt-circle-right"></i></Link>
                </div>
            </div>
                ...
                <div className="mobile-nav__content">
                    ...
                    <div className="mobile-nav__container">
                        <ul className="main-menu__list">
                            ...
                            <li>
                                <Link to="/newsmain" onClick={() => setmobile(false)}>News</Link>
                            </li>
                            <li>
                            ...
                            <li>
                                <Link to="/onlinebooking" onClick={() => setmobile(false)}>Online Booking</Link>
                            </li>
                            <li>
                                <Link to="/pricing" onClick={() => setmobile(false)}>Pricing</Link>
                            </li>
                            <li>
                    ...
                    <ul className="mobile-nav__contact list-unstyled">
                        <li>
                            ...
                            <Link to="mailto:needhelp@packageName__.com">needhelp@crsine.com</Link>
                        </li>
                        <li>
