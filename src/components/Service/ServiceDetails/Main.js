                        ...
                        <div className="row">
                            <div className="col-lg-4">
                                ...
                                <div className="faq-one__call" style={{ backgroundImage: `url(${BGimg})` }}>
                                    ...
                                    <Link to="tel:92-666-888-000" className="faq-one__call-number" >92 666 888 000</Link>
                            ...
                            <div className="col-lg-8">
                                ...
                                <p className="service-details__text">
                                    ...
                                    dummy text of the printing and typesetting industry. Lorem Ipsum has been the ndustry standard dummy
                ...
                <section className="call-to-action">
                    <div className="container">
                        ...
                        <div className="call-to-action__btn-wrap">
                            <Link to="online-booking.html" className="thm-btn">
                                Book Appointment
                                <i className="far fa-arrow-alt-circle-right"></i>
                            </Link>
                        </div>
