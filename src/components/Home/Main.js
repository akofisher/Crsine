        ...
        <>
            ...
            <section className="main-slider">
                ...
                >
                    <div className="swiper-wrapper">
                        ...
                        <SwiperSlide>
                            <div className="swiper-slide">
                                <div className="image-layer" style={{ backgroundImage: `url(${BGImg1})` }}>
                                </div>
                        ...
                        <div className="col-lg-6">
                            <div className="about-two__content">
                                <div className="section-title">
                                    ...
                                    <h2 className="section-title__title">It’s Time to Come and <br />
                                        Clean Your Car</h2>
                                </div>
            ...
            <section className="service-home">
                ...
                <div className="container">
                    ...
                    <div className="row ">
                        <div className="col-sm-12 col-md-12 col-lg-4 wow fadeInLeft" data-wow-duration="1500ms">
                        ...
                        <div className="col-sm-12 col-md-12 col-lg-4 wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="100ms">
                            <div className="service-card">
                                <div className="service-card__image">
                        ...
                        <div className="col-sm-12 col-md-12 col-lg-4 wow fadeInRight" data-wow-duration="1500ms" data-wow-delay="200ms">
                            <div className="service-card">
                                <div className="service-card__image">
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-4">
                                <div className="section-title">
                                    <span className="section-title__tagline">What We’re Offering</span>
                                    <h2 className="section-title__title">Premium Car <br />
                                        Washing Center</h2>
                                </div>
                                <Link to="/onlinebooking" className="thm-btn">Appointment <i className="far fa-arrow-alt-circle-right"></i></Link >
            ...
            <section className="feature-one">
                <div className="video-one wow fadeInLeft" data-wow-duration="1500ms">
                    ...
                    <div className="video-one__content">
                        ...
                        <p className="video-one__text">We specialize
                            in detailing
                            and cars
                            washing</p>
                    </div>
                    ...
                    <div className="row justify-content-xl-end">
                        <div className="col-lg-7">
                            <div className="feature-one__content">
                                <div className="section-title">
                                    <span className="section-title__tagline">Our Service Benefits</span>
                                    <h2 className="section-title__title">Why You Should Choose <br />
                                        Our Services</h2>
                                </div>
                                <div className="feature-one__summery">
                                    ...
                                    or words which don't look even slightly believable of but the majority have suffered.
                                </div>
                                ...
                                <ul className="list-unstyled feature-one__progress">
                                    <li className="feature-one__progress-item">
                                        <span className="feature-one__progress-title">Cleaning</span>
                                        <div className="feature-one__progress-bar">
                                            <span className="feature-one__progress-main" style={{ width: '77%' }}>
                                    ...
                                    <li className="feature-one__progress-item">
                                        ...
                                        <div className="feature-one__progress-bar">
                                            <span className="feature-one__progress-main" style={{ width: '58%' }}>
                                ...
                                <div className="feature-one__counter">
                                    ...
                                    <div className="feature-one__counter-content">
                                        <h3 className="feature-one__counter-title odometer" data-count="867000"><AnimatedNumber value={867000} duration={6000} formatValue={(v) => Math.round(v)} /></h3>

                                        <p className="feature-one__counter-text">Happy customers in 30 years of washing</p>
            ...
            <section className="pricing-one">
                <div className="container">
                    <div className="section-title text-center">
                        ...
                        <h2 className="section-title__title">Looking for Car Wash? <br />
                            Choose a Plan</h2>
                    </div>
                    ...
                    <div className="tab-box" id="price-tab">
                        ...
                        <div className={`tab-box__content ${tabMenu.minivancan && "active-item"}`}>
                            <div className="row">
                                <div className="col-md-12 col-lg-4">
                                    <div className="price-card">
                                        <p className="price-card__name">Basic Washing</p>
                        ...
                        <div className={`tab-box__content ${tabMenu.SUVCar && "active-item"}`}>
                            <div className="row">
                                <div className="col-md-12 col-lg-4">
                                    <div className="price-card">
                                        <p className="price-card__name">Basic Washing</p>
                        ...
                        <div className="col-xl-6">
                            <div className="feature-two__content">
                                <div className="section-title">
                                    ...
                                    <h2 className="section-title__title">We Only Provide Quality <br />
                                        Care Services</h2>
                                </div>
